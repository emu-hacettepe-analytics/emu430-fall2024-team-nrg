...
**countries_by_income:** A value distribution which represents the countries according to their income levels. These levels are: Upper-middle-income countries, Lower-middle-income countries, Low-income countries and High-income countries.

**total_co2_emission_by_income:** Bunu degistirebiliriz. Line plot yapilabilir duzeltilsin.
...
**year:** A column in my_data2 data set which represents the year.

**region:** A column in my_data2 data set which represents the countries and the world.

**powertrain:** A column in my_data2 data set which represents how the vehicle gets its power from, a.k.a. type of the powertrain that the vehicle uses which are EV, BEV, PHEV etc.
...
In this part of analysing, my_data4 will be using. Therefore, here is the general information that's needed:
