...
This data is used for detecting global electric vehicle sales by country and
across the world.
...
This data is used to determine vehicle-related CO2 emissions globally and by
country.
...
Before starting the analysis, let's make the columns more understandable. Note
that the time frame between 2011 and 2021 will be used in the analysis.
